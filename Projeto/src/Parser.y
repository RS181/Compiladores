...
--  : Type ident '(' ParamList ')' Stmt     {FunDecl $1 $2 $4 $6}         
...
-- continue e break só podem ser usados dentro de for e while

--Retirar ; daqui e por no SimpleExp
SimpleExp
  : Exp           { SimpleExp $1 }
  -- | AssignStmTE   { $1 }   
  -- | AssignStmT    { $1 }

--AssignStmTE e AssignStmT dentro de SimpleExp
{-
AssignStmTE
  : Type ident '=' Exp     { AssignStmTE  $1 $2 $4 }

AssignStmT
  : Type IdentList   { AssignStmT $1 $2 }
-}
...
--TODO tentar fazer DeclList e alterar bloco 

While
  -- : while '(' Exp ')' Block2          { While $3 $5 } 
     : while '(' Exp ')' Stmt          { While $3 $5 } 

  -- : while '(' Exp ')' LoopBlock          { While $3 $5 } 
--  : while '(' Exp ')' Stmt      { While $3 $5 }

For
  : for '(' AssignStm Exp ';' Exp ')' Stmt  { For $3 $4 $6 $8 }

  -- : for '(' AssignStm Exp ';' Exp ')' LoopBlock  { For $3 $4 $6 $8 }
--  : for '(' AssignStm RelExp ';' Exp ')' LoopBlock  { For $3 $4 $6 $8 }
...
--  | real                  { RealLiteral $1 }
  ...
  | '!' Exp               { Not $2 } -- logico
  --  | Exp BinOp Exp         { BinOp $1 $2 $3 } -- causa conflitos shift reduce
...
{-
-- Usar BinOp assim causa shift reduce conflits
BinOp
  : '+'   { Plus }
  | '-'   { Minus }
  | '*'   { Mult }
